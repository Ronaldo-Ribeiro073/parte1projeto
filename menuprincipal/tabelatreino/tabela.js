...
function cadtreino(exercicio, carga, series, repeticoes, intervalo) {
    ...
    cellordem.innerHTML = qtdlLinhas;
...
function alttreino(exercicio, carga, series, repeticoes, intervalo) {
